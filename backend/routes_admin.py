...
async def public_settings():
    ...
    return {
        ...
        'theme_bg': s.get('theme_bg', '#0A0A0A'),
        'theme_surface': s.get('theme_surface', '#141414'),
        'theme_text': s.get('theme_text', '#F5F1EA'),
        'theme_text_muted': s.get('theme_text_muted', 'rgba(245,241,234,0.65)'),
        'theme_accent': s.get('theme_accent', '#C8A96A'),
        'theme_accent_soft': s.get('theme_accent_soft', 'rgba(200,169,106,0.18)'),
        'theme_hairline': s.get('theme_hairline', 'rgba(200,169,106,0.25)'),
        'font_serif': s.get('font_serif'),
        'font_sans': s.get('font_sans'),
        'font_mono': s.get('font_mono'),
        'google_fonts_url': s.get('google_fonts_url'),
    }
